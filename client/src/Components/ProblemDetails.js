          ...
          <div className="flex-grow-0 h-12 ">
            ...
            <button
              ...
              onClick={() => {
                ...
                setShowResults(true);
                setResult("Compiling...");
                //here we are setting the result to compiling before calling the method handleSubmit, as the state update is async but it will update to compiling... before the new result is fetched from the api for sure, so the user experience will be improved
                handleSubmit();
              }}
            >
              Submit
